...
if(darkMode=='dark'){
  ...
  return (
    ...
    <div className="grid grid-cols-5 h-screen text-center">
      <select onChange={(event)=>setDarkMode(event.target.value)}  className={`fixed bottom-0 p-2 rounded-md ${
    darkMode === 'dark' ? 'bg-zinc-800 text-white' : 'bg-red-100 text-black'
  }`}>
